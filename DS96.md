...
### Соединение left join выбирает все строки из ревой таблицы, если совпадет и во второй таблице, то вернется значение из нее, которое совпадет. В противном случае во второй таблице, которая справа вернется null
...
[View on DB Fiddle](https://www.db-fiddle.com/f/cy9vkGYgEY7KQhenqRdS9i/13)
