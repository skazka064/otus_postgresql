...
### результаты получились отличные, даже с количеством потоков=10 , пока это самый большой TPS и самая маленькая задержка. Даже по графику видно, что процессорные мощности использовались в оптимальном режиме.
