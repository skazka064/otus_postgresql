...
![Иллюстрация к проекту](img/2024-12-25_12-19-31.png)


### результаты получились отличные, даже с количеством потоков=10 , пока это самый большой TPS и самая маленькая задержка. Даже по графику видно, что процессорные мощности использовались в оптимальном режиме, расход памяти тоже в норме. Все основные системы работали не в пике нагрузки. Но производительность на данный момент максимальная
