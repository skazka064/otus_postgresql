...
```
### Мы воспроизвели ситуацию, при которой две транзакции UPDATE без WHERE заблокировали друг друга. Два курсора "встретились" на второй строке табрицы. Петвая и третья строка прошли успешно, т.к. первая транзакция начала читать таблицу, отсортированную в прямом порядке, а вторая начала работать с таблицей отсортированной в обратном порядке. 
