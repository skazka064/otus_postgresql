...
#### посмотрим утилизацию во время нагрузки 1 -DEFUALT 2- WEB 3 - попробуем накрутить work_mem до 10GB + предыдущие WEB настройки(посмотрим загрузку железа) 4. Увеличим max_conn до 1500 + предыдущие настройки 
