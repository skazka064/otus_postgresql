...
#### Решил увеличить work_mem = 10MB т.к. я предположил, что в этих скриптах имеются запросы с  сортировками ; 
...
SQL statistics:
    queries performed:
        ...
        other:                           139880
        total:                           1374014
    transactions:                        39269  (324.49 per sec.)
    queries:                             1374014 (11353.76 per sec.)
    ignored errors:                      30790  (254.42 per sec.)
    reconnects:                          0      (0.00 per sec.)

General statistics:
    total time:                          121.0156s
    total number of events:              39269
...
Threads fairness:
    events (avg/stddev):           436.3222/24.60
    execution time (avg/stddev):   120.3642/0.33
